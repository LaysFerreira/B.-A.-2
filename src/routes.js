...
router.get('/meliponarios', isAuthenticated, async (req, res) => {
 try {
 const regioes = req.query.regioes;
...
router.post('/meliponarios', isAuthenticated, async (req, res) => {
  try {
...
router.post('/meliponicultores', isAuthenticated, async (req, res) => {
  try {
